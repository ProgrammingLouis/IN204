...
class MyWindowStaticBox<MyStaticWindow> : MyDrawable
{
    public:
        ...
        void draw(sf::RenderWindow& drawWindow, float pixPerMeter)
        {
            ...
            if (&drawWindow == (MyWindow*)(&this->window)) {
                shape.setPosition(posOnAttachedWin);
                drawWindow.draw(shape);
                return;
            }
            ...
            sf::Vector2i winPos = drawWindow.getPosition();
            sf::Vector2u winSize = drawWindow.getSize();
...
////////////////////////////////////////////////////////////
template <>
class MyWindowStaticBox<MyWindow> : public MyWindowStaticBox<MyStaticWindow>, MyWindowStaticObject
{
    public:
        ...
        ///
        ////////////////////////////////////////////////////////////
        MyWindowStaticBox(const sf::Vector2f& winPosition, const sf::Vector2f& screenHalfSize, float angle, b2World& world, float pixPerMeter, MyWindow*window) : MyWindowStaticBox<MyStaticWindow>(winPosition, screenHalfSize, angle, world, pixPerMeter, (MyStaticWindow*)(window)), window(window)
        {
        }
